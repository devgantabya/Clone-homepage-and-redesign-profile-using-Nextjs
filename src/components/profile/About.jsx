...
const About = () => {
  return (
    <section
      className="bg-[#FAF8F5] py-24 hidden md:block"
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="space-y-8 text-xl leading-relaxed">
          <p>
            ...
            anxiety, stress, or the lingering effects of past experiences. Many
            of the people I work with are high-achieving, thoughtful, and
          ...
          <p>
            ...
            difficulty sleeping, or a sense that they are always bracing for
            something to go wrong. Others are navigating the impact of earlier
            life experiences that continue to affect their relationships,
            confidence, or sense of safety.
          </p>
          <p>
          ...
          <p>
            ...
            who have experienced single-incident trauma as well as more complex,
            long-standing patterns that may stem from childhood, relationships,
            or chronic stress. My approach is paced carefully, with an emphasis
            on safety, stabilization, and helping clients feel more regulated in
            their daily lives—not just during sessions.
          </p>
          <p>
            ...
            pressure. Many are entrepreneurs, creatives, or professionals who
            feel disconnected from themselves after years of pushing through
            stress. Therapy can become a space to slow down, reconnect, and
          ...
          <p>
            If you are looking for a therapist who combines practical tools with
