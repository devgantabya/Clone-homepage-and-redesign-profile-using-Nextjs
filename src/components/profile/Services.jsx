...
const services = [
  ...
  {
    title: "Professional Burnout and Perfectionism",
    description:
  ...
  return (
    <section className="bg-[#F5EBDD] py-12 md:py-24">
      <div className="container mx-auto px-6 text-center">
        <h2
          className={`${headingFont.className} text-[#4DB6AC] text-3xl md:text-5xl font-semibold`}
        >
          Services Offered
        </h2>
        ...
        <div className="mt-10 md:mt-16 grid gap-10 md:grid-cols-3">
          {services.map((service, i) => (
            ...
            >
              <h3
                className={`${headingFont.className} text-2xl text-[#4DB6AC] font-semibold mb-4`}
              >
                {service.title}
              </h3>
