        ...
        <div className="w-full md:w-1/2 flex flex-col text-primary">
          <div className="flex-1 flex items-center justify-center md:justify-start px-6 md:px-20 py-12 md:py-0">
            <div>
              ...
              <p
                data-aos="fade-up"
                className="mt-6 text-base sm:text-lg max-w-md"
              >
          ...
          <div data-aos="fade-up" className="border-t border-[#223614]">
            <a
              href="https://lilac-template.squarespace.com/contact"
              className="w-full flex items-center justify-center px-6 md:px-20 py-4 md:py-6 uppercase text-sm tracking-wide hover:bg-[#223614] hover:text-white transition-all duration-500"
            >
